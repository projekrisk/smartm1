...
<body class="text-gray-900">
    ...
    <div class="flex flex-col items-center py-10 print:py-0 print:block">
        ...
        <div class="cetak-kertas page-break print:mt-0 mt-10">
            ...
            <h3 style="text-align: left; margin-bottom: 15px; font-size: 14pt;">LAMPIRAN SURAT DISPENSASI</h3>
            ...
            <table class="tabel-siswa">
                <thead>
                    <tr style="background-color: #f3f4f6;">
                        ...
                        <th style="width: 30%; text-align: center;">NISN / NIS</th>
                        <th style="width: 50%; text-align: center;">Nama Peserta Didik</th>
