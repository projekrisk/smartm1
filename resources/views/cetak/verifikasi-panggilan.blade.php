    ...
    <div class="w-full max-w-3xl bg-uisurface rounded-[32px] shadow-[0_20px_60px_rgba(0,0,0,0.05)] border border-uiborder overflow-hidden flex flex-col">
        ...
        <div class="p-6 sm:p-10 flex flex-col gap-8">
            ...
            <div class="pb-6 border-b border-uiborder">
                <p class="text-[12px] font-bold text-uimuted uppercase tracking-wider mb-2">Wali Murid Dari Siswa:</p>
                ...
                <h2 class="text-[22px] sm:text-[22pt] font-black text-uiblack tracking-tight leading-tight break-words">
                    {{ $siswa ? ucwords(strtolower($siswa->nama_lengkap)) : '-' }}
                </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                ...
                <div class="flex flex-col">
                    <span class="text-[12px] font-bold text-uimuted uppercase tracking-wider mb-1">Jadwal Kehadiran</span>
                    <span class="text-[15px] sm:text-[16px] font-black text-uiblack">
                        {{ \Carbon\Carbon::parse($surat->tanggal_panggilan)->isoFormat('dddd, D MMMM Y') }}
                    </span>
                    <span class="text-[13px] font-semibold text-gray-600 mt-0.5">Pukul {{ date('H:i', strtotime($surat->waktu_panggilan)) }} WIB</span>
                </div>

                <div class="flex flex-col">
                    <span class="text-[12px] font-bold text-uimuted uppercase tracking-wider mb-1">Tempat Pertemuan</span>
                    <span class="text-[15px] sm:text-[16px] font-black text-uiblack">{{ $surat->tempat_pertemuan }}</span>
                </div>
